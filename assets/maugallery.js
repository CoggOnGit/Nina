        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-body">
              ${navigation
          ? '<div class="mg-prev" style="cursor:pointer;position:absolute;top:50%;left:-15px;background:white;">&laquo;</div>'
          : '<span style="display:none;" />'
        }
              <img class="lightboxImage img-fluid" alt="Image de la lightbox"/>
              ${navigation
          ? '<div class="mg-next" style="cursor:pointer;position:absolute;top:50%;right:-15px;background:white;}">&raquo;</div>'
          : '<span style="display:none;" />'
        }
            </div>
          </div>
